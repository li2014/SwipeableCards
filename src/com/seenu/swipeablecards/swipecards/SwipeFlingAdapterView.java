...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
	...
	public SwipeFlingAdapterView(Context context, AttributeSet attrs,
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.SwipeFlingAdapterView, defStyle, 0);
		MAX_VISIBLE = a.getInt(R.styleable.SwipeFlingAdapterView_max_visible,
				MAX_VISIBLE);
	...
	protected void onLayout(boolean changed, int left, int top, int right,
		...
		if (adapterCount == 0) {
			...
			if (mActiveCard != null && topCard != null
					&& topCard == mActiveCard) {
						...
						new FlingCardListener.FlingListener() {
							...
							public void onClick(Object dataObject) {
								if (mOnItemClickListener != null)
									mOnItemClickListener.onItemClicked(0,
											dataObject);
